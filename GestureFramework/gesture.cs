        ...
        private bool CompareJointRelationship(Joint inJoint1, Joint inJoint2, JointRelationship relation)
        {
            switch (relation)
            {
                ...
                case JointRelationship.Below:
                    return inJoint1.Position.Y > inJoint2.Position.Y && Math.Abs(inJoint1.Position.Y - inJoint2.Position.Y) > Math.Abs((inJoint1.Position.X - inJoint2.Position.X) * 10.0f);
                case JointRelationship.Above:
                    return inJoint1.Position.Y < inJoint2.Position.Y && Math.Abs(inJoint1.Position.Y - inJoint2.Position.Y) > Math.Abs((inJoint1.Position.X - inJoint2.Position.X) * 10.0f);
                case JointRelationship.LeftOf:
                    return inJoint1.Position.X < inJoint2.Position.X && Math.Abs(inJoint1.Position.X - inJoint2.Position.X) > Math.Abs((inJoint1.Position.Y - inJoint2.Position.Y) * 10.0f);
